...
namespace BankDirectoryApi.Application.Interfaces
{
    public interface IUserService
    {
        ...
        public Task<AuthDTO?> ResetPasswordAsync(ResetPasswordDTO model);
        ...
        public Task<bool?> Logout(string refreshToken); //Token Blacklisting
        public Task<bool?> DeleteUserAsync(string userId);
        public Task<IEnumerable<string>?> DeleteUsersAsync(IEnumerable<string> userIds);
        public Task<AuthDTO?> GenerateAccessTokenFromRefreshTokenAsync(string refreshToken);
